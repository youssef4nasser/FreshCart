  ...
  <section className='py-5'>
    <div className="container">
      ...
      <form onSubmit={formik.handleSubmit} className='w-75 m-auto'>
        <h3>Register Now : </h3>
        {messageError.length > 0 ? <div className="alert alert-danger">{messageError}</div>: ""}
        ...
        {isloading ? <button type='butto' className='main-bg border-0 p-2 rounded-3 text-white'><i className='fas fa-spinner fa-spin'></i></button> 
                   : <button disabled={!(formik.isValid && formik.dirty)} type='submit' className='main-bg border-0 p-2 rounded-3 text-white'>Register</button>}
